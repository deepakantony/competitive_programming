...
// strings formed by considering all unique substrings of the string wi. 
// A substring is defined as a contiguous sequence of one or more characters 
// in the string. More information on substrings can be found here. Let 
// 'S' = {S1 U S2 U .... Sn} .i.e 'S' is a set of strings formed by 
// considering all the unique strings in all sets S1, S2, ..... Sn. You 
// will be given many queries and for each query, you will be given an 
// integer 'k'. Your task is to output the lexicographically kth smallest 
...
// number of strings. Each of the next 'n' lines consists of a string. 
// The string on the ith line (1<=i<=n) is denoted by wi and has a length 
// mi. The next line consists of a single integer 'q', denoting the number 
// of queries. Each of the next 'q' lines consists of a single integer 'k'.
// 
...
// "aab".
// S2 = {"a", "aa", "aac",  "ac", "c" } . These are the 5 unique substrings 
// of "aac".
...
// lexicographically 8th smallest string in 'S' is "c". Since there are 
// only 8 distinct substrings, the answer to the last query is "INVALID".
// 
