...
def displayPathtoPrincess(n,grid):
    ...
    if px <= mx: # princess is left of bot
        for _ in range(mx-px): print ("LEFT") ; return
    elif px > mx: # princess is right of bot
        for _ in range(px-mx): print ("RIGHT") ; return
    if py <= my: # princess is top corners
        for _ in range(my-py): print ("UP") ; return 
    if py > my: # princess is in bottom corners
        for _ in range(py-my): print ("DOWN") ; return
